            ...
            <div class="card-body">
                ...
                <form class="form-material form-horizontal m-t-30" enctype="multipart/form-data" method='POST'>
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <input type="text" id="example-text" name="name" class="form-control" value="<?= $supplier['name']; ?>" placeholder="Enter company name">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <input type="email" id="email" name="email" class="form-control" placeholder="Enter your email" value="<?= $supplier['email']; ?>">
                        </div>
                    </div>
